...
export function advanceFloraSession(session) {
  ...
  switch (session.stage) {
    ...
    case "tall_grass": {
      const grassFrequency = session.sourceBiome === BIOME_IDS.TWILIGHT_CLEARINGS
        ? 3
    ...
    case "red_mushroom":
      ...
      session.stage = session.sourceBiome === BIOME_IDS.TWILIGHT_MUSHROOM
...
export function applyTwilightFlora(region, sourceBiome, random, chunkX, chunkZ) {
